...
class _ContactListPageState extends State<ContactListPage> {
  ...
  Future<void> refreshContacts() async {
    ...
    var contacts = (await FlutterContactsService.getContacts(
...
//          ;
    ...
    for (final contact in contacts) {
      FlutterContactsService.getAvatar(contact).then((avatar) {
  ...
  _openContactForm() async {
    try {
      var _ = await FlutterContactsService.openContactForm(
...
//          ),
          IconButton(
            ...
            onPressed: () => FlutterContactsService.deleteContact(_contact),
          ),
          IconButton(
        ...
        actions: <Widget>[
          TextButton(
            onPressed: () {
              ...
              FlutterContactsService.addContact(contact);
              Navigator.of(context).pop();
            },
